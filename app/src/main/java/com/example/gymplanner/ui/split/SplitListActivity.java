    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        buttonNavTreino.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SplitListActivity.this, StartTrainingActivity.class);
                startActivity(intent);
        ...
        buttonNavSplit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SplitListActivity.this, SplitListActivity.class);
                startActivity(intent);
        ...
        buttonNavHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SplitListActivity.this, TrainingHistoryActivity.class);
                startActivity(intent);
